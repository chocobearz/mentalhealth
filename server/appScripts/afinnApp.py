...
LANGUAGE_TO_FILENAME = {
    'ab': '/app/lexicons/absolutismLexicon.txt'),
    'en': '/app/lexicons/AFINN-en-165.txt'),
    'em': '/app/lexicons/emergency.txt'),
    're': '/app/lexicons/researchLexicon.txt'),
    'emoticons':'/app/lexicons/AFINN-emoticon-8.txt'),
    }
